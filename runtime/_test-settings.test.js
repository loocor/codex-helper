...
test("native settings pages follow worktree-style sparse list layout", () => {
  ...
  expect(settingsSource).toContain("data-codex-helper-log-search");
  expect(settingsSource).toContain("data-codex-helper-log-date");
  expect(settingsSource).toContain("data-codex-helper-log-event-filter");
  expect(settingsSource).toContain("data-codex-helper-log-regex");
  expect(settingsSource).toContain("scheduleHelperLogSearch(");
  expect(settingsSource).toContain("HELPER_LOG_SEARCH_DEBOUNCE_MS");
  expect(settingsSource).toContain('addEventListener("input", onHelperSettingsInput, true)');
  expect(settingsSource).toContain("payload.event = query.event");
  expect(settingsSource).toContain("data-codex-helper-log-detail");
  expect(settingsSource).toContain("data-codex-helper-log-detail-body");
  expect(settingsSource).toContain('"logs-prev"');
  expect(settingsSource).toContain('"logs-next"');
  expect(settingsSource).toContain('"logs-open"');
  expect(settingsSource).toContain('"logs-back"');
  expect(settingsSource).toContain("helperLogPager.query");
  expect(settingsSource).toContain("helperLogDateLabel");
  expect(settingsSource).toContain('nativeSettingsIconButton("refresh", "Refresh", "refresh")');
  expect(settingsSource).toContain('bridge("/diagnostics/list"');
  expect(settingsSource).toContain('bridge("/diagnostics/search"');
  expect(settingsSource).toContain("Browse Helper diagnostics by date");
  expect(nativeSettingsSource).not.toContain("data-codex-helper-log-path");
  expect(nativeSettingsSource).not.toContain("open-log-file");
  expect(settingsSource).toContain("createLogDetailJsonSection(");
  expect(settingsSource).toContain("data-codex-helper-log-event");
  expect(settingsSource).toContain("setHelperLogDetailEvent(");
  expect(settingsSource).toContain('"Copy record"');
  expect(settingsSource).toContain("codex-helper-native-settings-log-json-copy");
  expect(settingsSource).not.toContain("codex-helper-native-settings-log-json-header");
  expect(settingsSource).not.toContain('createLogDetailJsonSection("Request"');
  expect(settingsSource).not.toContain('createLogDetailJsonSection("Response"');
  expect(settingsSource).toContain('pushLogDetailField(rows, "Provider", detailObject.providerId)');
  expect(settingsSource).toContain('"Rate"');
  expect(settingsSource).toContain("x-ratelimit-remaining-requests");
  expect(settingsSource).toContain('"logs-copy-record"');
  expect(settingsSource).toContain('"logs-reveal-session"');
  expect(settingsSource).toContain('bridge("/diagnostics/reveal-session"');
  expect(settingsSource).toContain("logListMetricParts(");
  expect(settingsSource).toContain('record?.event !== "llm.request" && record?.preview');
  expect(settingsSource).toContain("detailObject.sessionId");
  expect(settingsSource).toContain("detailObject.turnId");
  expect(settingsSource).toContain("` · ${metrics}`");
  expect(settingsSource).not.toContain("detailObject.userPreview");
  expect(settingsSource).not.toContain("record?.detail?.userPreview");
  expect(settingsSource).not.toContain('pushLogDetailField(rows, "User"');
  expect(settingsSource).toContain("bindLogDetailSplitter");
  expect(settingsSource).toContain("codex-helper-native-settings-log-split-handle");
  expect(settingsSource).toContain('record?.event !== "llm.request"');
  expect(settingsSource).toContain("createLogDetailRecordPane(");
  expect(settingsSource).toContain("formatLogDetailScalar");
